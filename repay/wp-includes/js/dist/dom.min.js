    ...
    function ot(t, e, n, r) {
        Array.from(t).forEach((t => {
            ...
            if (!n.hasOwnProperty(o) || n[o].isMatch && !n[o].isMatch ? .(t)) ot(t.childNodes, e, n, r), r && !et(t) && t.nextElementSibling && z(e.createElement("br"), t), k(t);
                ...
                if (t.hasChildNodes()) {
                    if ("*" === s) return;
                    if (s) c.length && !t.querySelector(c.join(",")) ? (ot(t.childNodes, e, n, r), k(t)) : t.parentNode && "BODY" === t.parentNode.nodeName && et(t) ? (ot(t.childNodes, e, n, r), Array.from(t.childNodes).some((t => !et(t))) && k(t)) : ot(t.childNodes, e, s, r);
                    else
