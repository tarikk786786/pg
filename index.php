...
<nav class="navbar" id="navbar">
    <div class="container">
        ...
        <a href="https://wp.adityaloot.com/auth/index" class="nav-cta"><i class="ri-dashboard-3-line"></i> Dashboard</a>
...
<div class="mobile-menu" id="mobileMenu">
    ...
    <a href="https://wp.adityaloot.com/auth/index" class="nav-cta" style="margin-top:20px; font-size: 1.1rem;"><i class="ri-login-circle-line"></i> Sign In</a>
</div>
    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div class="hero-actions">
                <a href="https://wp.adityaloot.com/Register" class="btn-primary"><i class="ri-rocket-2-fill"></i> Get Started Free</a>
    ...
    <div class="container">
        ...
        <div class="pricing-grid">
            <div class="pricing-card reveal">
                ...
                <a href="https://wp.adityaloot.com/Register" class="btn-outline" style="width: 100%;"><i class="ri-user-add-line"></i> Create Account</a>
            </div>
            ...
            <div class="pricing-card featured reveal">
                ...
                <a href="https://wp.adityaloot.com/Register" class="btn-primary" style="width: 100%;"><i class="ri-rocket-line"></i> Upgrade to Pro</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="cta-card reveal">
            ...
            <div class="cta-actions">
                <a href="https://wp.adityaloot.com/Register" class="btn-primary" style="background: #fff; color: var(--primary-dark);"><i class="ri-user-star-line"></i> Create Free Account</a>
...
<footer class="footer">
    <div class="container">
        ...
        <div class="footer-bottom">
            ...
            <p>Developed with <i class="ri-heart-fill" style="color: var(--secondary);"></i> by <a href="https://dgweb.in" style="color: #fff; font-weight: 600;">DGWeb</a></p>
        </div>
    </div>
</footer>
