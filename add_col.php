...
$check = mysqli_query($conn, "SELECT * FROM website_settings");
if(mysqli_num_rows($check) == 0){
    mysqli_query($conn, "INSERT INTO website_settings (title, contact_email) VALUES ('Super Admin Dashboard', 'admin@example.com')");
}
